...
class Loss(nn.Module):
  ...
  def forward(self,predict,target):
    cls_pred,reg_pred,center_pred = torch.split(predict,[self.num_class,4,1],dim=1)
    cls_gt, reg_gt, center_gt = target
    ...
    return total_loss,cls_loss,reg_loss,center_loss
